# -*- coding: utf-8 -*-
# Created by xieenning at 2020/3/27
import unicodedata
...
class Tokenizer(object):
    ...
    def tokenize_once(self, text1, text2=None):
        """Split text to tokens.
        :param text1: First text.
        :param text2: second text.
        :return: A list of strings.
        """
        text1_tokens = self._tokenize(text1)
        if text2 is None:
            return self._convert_tokens_to_ids(text1_tokens)
        text2_tokens = self._tokenize(text2)
        return self._convert_tokens_to_ids(text1_tokens), self._convert_tokens_to_ids(text2_tokens)
