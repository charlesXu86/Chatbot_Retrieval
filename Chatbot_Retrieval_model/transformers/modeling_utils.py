...
class PreTrainedModel(nn.Module, ModuleUtilsMixin):
    ...
    def prune_heads(self, heads_to_prune):
        ...
        """
        # saved_models new sets of pruned heads as union of previously stored pruned heads and newly pruned heads
    ...
    def save_pretrained(self, save_directory):
        ...
        # Only saved_models the model itself if we are using distributed training
        ...
        # If we saved_models using the predefined names, we can load using `from_pretrained`
